...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      url: 'postgresql://chakradbuser:chakradbpassword@chakradb-prod-1.crqfsmm4xyxl.ap-south-1.rds.amazonaws.com:5432/chakra',
      // url: 'postgresql://chakradbuser:chakradbpassword@readreplica-chakradb-prod-1.crqfsmm4xyxl.ap-south-1.rds.amazonaws.com:5432/chakra',
    ...
    auditlogs: {
      adapter: 'sails-postgresql',
      url: 'postgresql://chakradbuser:chakradbpassword@chakradb-auditlogs-1.crqfsmm4xyxl.ap-south-1.rds.amazonaws.com:5432/chakra_auditlogs',
    },
  ...
  ***************************************************************************/
  security: {
    ...
    ***************************************************************************/
    cors: {
      // allRoutes: true, // <- NEVER turn this on under any condition @sahoo
      allowOrigins: [
        'https://app.chakrahq.com',
        'https://beta.chakrahq.com',
      ],
      allowCredentials: true,
      // allowRequestMethods: 'GET,PUT,POST,DELETE,PATCH,OPTIONS,HEAD',
  ...
  ***************************************************************************/
  custom: {
    ...
    internalEmailAddress: 'support@chakrahq.com',

    googleClientId: '933973728044-9b8dkhgh55h03a172kif8q671vcbb21n.apps.googleusercontent.com',
  ...
  redis: {
    connectionUrl: 'redis://cubejs-1.mumbai.internal.chakrahq:6379',
  },
